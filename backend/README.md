...
## Project Structure
    ...
    ├── testapiautostorybo_107892  # Django project configurations
...
1. Clone this repo and `cd testapiautostorybo_107892`
...
2. Clone this repo and `cd testapiautostorybo_107892`
